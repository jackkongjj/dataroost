...
namespace CCS.Fundamentals.DataRoostAPI.Access.Voyager {
   ...
   //                         }
        ...
        //TODO : ToVerify : Can be commented out as the share information can be taken from Supercore Database only as Voyager is being deprecated.
  //      public void PopulateTypeOfShare(Dictionary<int, List<ShareClassDataDTO>> companyShareClasses) {
        ...
        //TODO : ToVerify : is it accepted if this method is returning the blank collection as output ?
        //                  otherwise this query is to be populated from some other database   
